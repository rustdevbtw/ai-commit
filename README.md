<!--toc:start-->
- [Forked](#forked)
- [**Committus: The Commit Message Generator**](#committus-the-commit-message-generator)
...
7. Approve the commit message and Committus will create the commit for you ✅
...
8. Approve the commit message and Committus will create the commit for you ✅
...
6. Type `cts` in your terminal
7. Committus will analyze your changes and generate a commit message
8. Approve the commit message and Committus will create a commit for you ✅
